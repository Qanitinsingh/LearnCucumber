...
public class RegisterOR {
	...
	public static final By HOBBIES_CRICKET = By.id("checkbox");
	...
	public static final By CHOOSE_IMAGE = By.id("uploadFile");
	...
	public static final By UPLOADIMG = By.cssSelector("gjxfhgjhd");

	public static final By PUSHIMAGE = By.className("submiggfdgdftbtn");
}
